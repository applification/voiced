...
final class StatusMenuController: NSObject, NSMenuDelegate, NSWindowDelegate {
    ...
    private func rebuildMenu() {
        ...
        menu.addItem(infoItem(title: "Control + Shift + Space: dictate and insert", symbolName: "arrow.turn.down.left"))
        menu.addItem(infoItem(title: "Control + Option + Shift + Space: save voice capture", symbolName: "waveform"))

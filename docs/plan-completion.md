...
- The App Store build stores WhisperKit's Hugging Face cache inside the sandbox container. The direct distribution build may use `~/Documents/huggingface/models/...`. Voiced exposes the path, size, reveal, and delete controls.
